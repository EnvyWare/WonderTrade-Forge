...
public class WonderTradeGraphics extends AbstractYamlConfig {
    ...
    public static class SelectPokemonUI {
        ...
        private ConfigInterface guiSettings = ConfigInterface.defaultInterface("WonderTrade", 5);
    ...
    public static class AdminUISettings {
        ...
        private ConfigInterface guiSettings = ConfigInterface.defaultInterface("WonderTrade", 6);
